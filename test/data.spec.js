...
describe('calculationHuman', ()=>{
it('calculationHuman should be a function', () => {
  expect(typeof calculationHuman).toBe('function');
});
it('calculationHuman should return true for "75"',() => {
  expect(calculationHuman(dataPrueba)).toBe(75);
});
});
