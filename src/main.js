...
export function renderStatistics() {
  ...
  container.innerHTML = `
    ...
    <div class="data-card">
    <p>*Did you know that the ${calculationHuman(data)}
    % of living beings are Humans?</p>
    <p>*The Muggle theme is quite critical in Harry Potter. 
    ¿Did you know that in the entire saga only ${calculationAncestry(data)}% are Muggles?</p>
    <p>*In the entire saga only ${calculationSex(data)}% are women </p>
    <img src="./Images/d1728fec95a41a01c99aceead563c3bf_360.gif" class="img-statistics">
    </div>
  `;
...
export function renderBooks() {
  ...
  resultBook.forEach(function (books) {
    ...
    card.innerHTML = `
      <img src="./Images/autora-removebg-preview (1).png" class="autora"> 
      <h4> ${books.title}</h4>
